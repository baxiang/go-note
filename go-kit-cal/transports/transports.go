...
func MakeHttpHandler(ctx context.Context, endpoint endpoints.CalEndpoints, zipkinTracer *gozipkin.Tracer, logger log.Logger) http.Handler {
	r := mux.NewRouter()
