...
func NewKitDiscoverClient(consulHost string, consulPort string) (DiscoveryClient, error) {
...
func (consulClient *KitDiscoverClient) Register(serviceName, instanceId,  instanceHost,instancePort ,healthCheckUrl string, meta map[string]string, logger *log.Logger) bool {
